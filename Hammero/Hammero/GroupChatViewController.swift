...
class GroupChat: JSQMessagesViewController {
   ...
   // var outgoingBubbleImageView : JSQMessagesBubbleImageFactory? = nil
//    outgoingMessageBubbleImageViewWithColor(UIColor.jsq_messageBubbleLightGrayColor())
    //var incomingBubbleImageView : JSQMessagesBubbleImageFactory? = nil
    ...
    func setupFirebase() {
        ...
        messagesRef = Firebase(url: "https://peopler.firebaseio.com/messages")
         println("it is a pleasure but can't load the next pleasure")
